...
public class NotificationsController {
    ...
    // if ((usages % TIMES_BEFORE_DONATION_NOTICE) == 0 &&
    ...
    // buildLabel(i18n().tr("You performed {0} tasks with PDFsam, did it help?",
    // Long.toString(usages)),
    // NotificationType.SUPPORT),
    // UrlButton.styledUrlButton(i18n().tr("Give something back"),
    // appBrand.property(BrandableProperty.DONATE_URL), null));
    // content.getStyleClass().add("notification-container");

    // // container.addStickyNotification(i18n().tr("PDFsam worked hard!"),
    // content);
    // }
    ...
    // 1.565C.139 1.908 0 3.08 0 3.768c0 .69.378 5.65.624 6.479c.815 2.736 3.713
    // 3.66 6.383 3.364q.204-.03.415-.056q-.207.033-.415.056c-3.912.58-7.387
    // 2.005-2.83 7.078c5.013 5.19 6.87-1.113 7.823-4.308c.953 3.195 2.05 9.271
    // 7.733 4.308c4.267-4.308 1.172-6.498-2.74-7.078a9 9 0 0
    // 1-.415-.056q.21.026.415.056c2.67.297 5.568-.628
    // 6.383-3.364c.246-.828.624-5.79.624-6.478c0-.69-.139-1.861-.902-2.206c-.659-.298-1.664-.62-4.3
    // 1.24C16.046 4.748 13.087 8.687 12 10.8");
    ...
    // new HBox(3, spacer,
    // UrlButton.styledUrlButton(null,
    // appBrand.property(BrandableProperty.FACEBOOK_SHARE_URL),
